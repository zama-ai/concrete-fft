...
pub mod x86 {
    ...
    pub(crate) fn _mm256_quick_two_sum(simd: Avx, a: __m256d, b: __m256d) -> (__m256d, __m256d) {
        let s = simd.avx._mm256_add_pd(a, b);
        (s, simd.avx._mm256_sub_pd(b, simd.avx._mm256_sub_pd(s, a)))
    }

    #[inline(always)]
    pub(crate) fn _mm256_two_sum(simd: Avx, a: __m256d, b: __m256d) -> (__m256d, __m256d) {
        let s = simd.avx._mm256_add_pd(a, b);
        let bb = simd.avx._mm256_sub_pd(s, a);
        (
            s,
            simd.avx._mm256_add_pd(
                simd.avx._mm256_sub_pd(a, simd.avx._mm256_sub_pd(s, bb)),
                simd.avx._mm256_sub_pd(b, bb),
            ),
        )
    }

    #[inline(always)]
    pub(crate) fn _mm256_two_diff(simd: Avx, a: __m256d, b: __m256d) -> (__m256d, __m256d) {
        let s = simd.avx._mm256_sub_pd(a, b);
        let bb = simd.avx._mm256_sub_pd(s, a);
        (
            s,
            simd.avx._mm256_sub_pd(
                simd.avx._mm256_sub_pd(a, simd.avx._mm256_sub_pd(s, bb)),
                simd.avx._mm256_add_pd(b, bb),
            ),
        )
    }

    #[inline(always)]
    pub(crate) fn _mm256_two_prod(simd: Avx, a: __m256d, b: __m256d) -> (__m256d, __m256d) {
        let p = simd.avx._mm256_mul_pd(a, b);
        (p, simd.fma._mm256_fmsub_pd(a, b, p))
    }

    #[cfg(feature = "nightly")]
    #[inline(always)]
    pub(crate) fn _mm512_quick_two_sum(simd: Avx512, a: __m512d, b: __m512d) -> (__m512d, __m512d) {
        let s = simd.avx512f._mm512_add_pd(a, b);
        (
            s,
            simd.avx512f
                ._mm512_sub_pd(b, simd.avx512f._mm512_sub_pd(s, a)),
        )
    }

    #[cfg(feature = "nightly")]
    #[inline(always)]
    pub(crate) fn _mm512_two_sum(simd: Avx512, a: __m512d, b: __m512d) -> (__m512d, __m512d) {
        let s = simd.avx512f._mm512_add_pd(a, b);
        let bb = simd.avx512f._mm512_sub_pd(s, a);
        (
            s,
            simd.avx512f._mm512_add_pd(
                simd.avx512f
                    ._mm512_sub_pd(a, simd.avx512f._mm512_sub_pd(s, bb)),
                simd.avx512f._mm512_sub_pd(b, bb),
            ),
        )
    }
    ...
    #[cfg(feature = "nightly")]
    #[inline(always)]
    pub(crate) fn _mm512_two_diff(simd: Avx512, a: __m512d, b: __m512d) -> (__m512d, __m512d) {
        let s = simd.avx512f._mm512_sub_pd(a, b);
        let bb = simd.avx512f._mm512_sub_pd(s, a);
        (
            s,
            simd.avx512f._mm512_sub_pd(
                simd.avx512f
                    ._mm512_sub_pd(a, simd.avx512f._mm512_sub_pd(s, bb)),
                simd.avx512f._mm512_add_pd(b, bb),
            ),
        )
    }
    ...
    #[cfg(feature = "nightly")]
    #[inline(always)]
    pub(crate) fn _mm512_two_prod(simd: Avx512, a: __m512d, b: __m512d) -> (__m512d, __m512d) {
        let p = simd.avx512f._mm512_mul_pd(a, b);
        (p, simd.avx512f._mm512_fmsub_pd(a, b, p))
    }
    ...
    impl Avx {
        ...
        pub fn _mm256_add_estimate_f128_f128(
            ...
            let (s, e) = _mm256_two_sum(self, a0, b0);
            let e = self.avx._mm256_add_pd(e, self.avx._mm256_add_pd(a1, b1));
            _mm256_quick_two_sum(self, s, e)
        }

        #[inline(always)]
        pub fn _mm256_sub_estimate_f128_f128(
            self,
            a0: __m256d,
            a1: __m256d,
            b0: __m256d,
            ...
            let (s, e) = _mm256_two_diff(self, a0, b0);
            let e = self.avx._mm256_add_pd(e, a1);
            let e = self.avx._mm256_sub_pd(e, b1);
            _mm256_quick_two_sum(self, s, e)
        }

        #[inline(always)]
        pub fn _mm256_mul_f128_f128(
            self,
            a0: __m256d,
            a1: __m256d,
            b0: __m256d,
            ...
            let (p1, p2) = _mm256_two_prod(self, a0, b0);
            let p2 = self.avx._mm256_add_pd(
                p2,
                self.avx._mm256_add_pd(
                    self.avx._mm256_mul_pd(a0, b1),
                    self.avx._mm256_mul_pd(a1, b0),
                ),
            );
            _mm256_quick_two_sum(self, p1, p2)
        }
    }
    ...
    impl Avx512 {
        #[inline(always)]
        pub fn _mm512_add_estimate_f128_f128(
            self,
            a0: __m512d,
            a1: __m512d,
            b0: __m512d,
            ...
            let (s, e) = _mm512_two_sum(self, a0, b0);
            let e = self
                .avx512f
                ._mm512_add_pd(e, self.avx512f._mm512_add_pd(a1, b1));
            _mm512_quick_two_sum(self, s, e)
        }

        #[inline(always)]
        pub fn _mm512_sub_estimate_f128_f128(
            self,
            a0: __m512d,
            a1: __m512d,
            b0: __m512d,
            ...
            let (s, e) = _mm512_two_diff(self, a0, b0);
            let e = self.avx512f._mm512_add_pd(e, a1);
            let e = self.avx512f._mm512_sub_pd(e, b1);
            _mm512_quick_two_sum(self, s, e)
        }

        #[inline(always)]
        pub fn _mm512_mul_f128_f128(
            self,
            a0: __m512d,
            a1: __m512d,
            b0: __m512d,
            ...
            let (p1, p2) = _mm512_two_prod(self, a0, b0);
            let p2 = self.avx512f._mm512_add_pd(
                p2,
                self.avx512f._mm512_add_pd(
                    self.avx512f._mm512_mul_pd(a0, b1),
                    self.avx512f._mm512_mul_pd(a1, b0),
                ),
            );
            _mm512_quick_two_sum(self, p1, p2)
        }
    }
}
